---
title: Check Samsung TV purchase status
excerpt: >-
  Use this endpoint to check the status of a Samsung TV in-app purchase. <br>
  The status returned in response can have three values: <br> <br> - `pending` -
...
api:
  file: test.json
  operationId: check-samsung-tv-purchase-status
hidden: false
---